...
class _LocationInputState extends State<LocationInput> {
  ...
  void _savePlace(double latite, double longtitude) async {
    final url = Uri.parse(
        'https://maps.googleapis.com/maps/api/geocode/json?latlng=$latite,$longtitude&key=AIzaSyDqdF5F--NW7p_TIcbHVSXMrEWsPvJTXJ0');
